...
function uploadSliderIMG(field){
    jQuery(document).ready(function($){
        var custom_uploader;
...
jQuery(document).ready(function($){
    ...
    $('#' + shortname + '_primaryColor, #' + shortname + '_primaryBigColor, #' + shortname + '_primaryBigBgColor, #' + shortname + '_linkColor, #' + shortname + '_linkHVColor, #' + shortname + '_secondaryColor, #' + shortname + '_linkMenu, #' + shortname + '_linkHVMenu,#' + shortname + '_footerColor,#' + shortname + '_footerBgColor, #' + shortname + '_bgColor').each(function(){
        var $el = $(this);
        $el.css({
            width: 100,
            height:36,
